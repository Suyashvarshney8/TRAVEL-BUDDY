...
class _FindaRideState extends State<FindaRide> {
  ...
  void getCurrentPosition() async {
    ...
    var firstAddress = address.streetAddress;
      ...
      child: Stack(
        children: <Widget>[
          SizedBox(
            ...
            child: ListView(
              children: <Widget>[
                _fillField("To: ", Colors.red, 20.0, Icons.location_pin),
                _dateField(),
              ],
            ),
          ),
          ...
          //     _onLocationPressed),
          _customButton(Alignment.bottomRight, 30.0, Icons.add, "Create",
              _onCreatePressed),
        ],
      ),
    );
  ...
  Align _fillField(String str, Color clr, double top, IconData icon) {
    return Align(
      ...
      child: Padding(
        padding: EdgeInsets.only(left: 20.0, right: 20.0, top: top, bottom: 5),
  ...
  Future<String?> _getAddressFromLatLng(LatLng point) async {
    GeoCode geoCode = GeoCode();
    Address addres = await geoCode.reverseGeocoding(
    ...
    var first = addres.streetAddress;
    String? name = addres.streetAddress;
    return name;
  }
